...
public class BlockedAppsAdapter extends BaseAdapter implements Filterable{
	...
	public View getView(final int position, View view, ViewGroup parent) {		
		...
		holder.cb.setOnClickListener(new View.OnClickListener() {
	        public void onClick(View v) {
	            ...
	            HelperUtils.upgradeNowDialogue(context);
	            ...
	            /*if (holder.cb.isChecked()) {
	                ...
	                SharedPreferenceUtils.setBlockedApps(context, n.getPackageName(), "");
	            } else if (!holder.cb.isChecked()) {
	            	nList.get(position).setIsSelected(false);
	                holder.cb.setChecked(false);
	                SharedPreferenceUtils.removeBlockedApp(context, n.getPackageName());
	            }*/
	        }
	    });
