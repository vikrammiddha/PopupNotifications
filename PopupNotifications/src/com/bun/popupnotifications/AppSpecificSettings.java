...
import com.bun.popupnotifications.R;
...
public class AppSpecificSettings  extends PreferenceActivity implements OnSharedPreferenceChangeListener{
	...
	private void setFont(){
		...
		final com.bun.popupnotifications.FontSelectionPreference customPref = (com.bun.popupnotifications.FontSelectionPreference) findPreference("app_font");
		...
		if(appFont != ""){
			...
			SharedPreferenceUtils.setAppFont(ctx,font , app);
		}else{
	...
	private void setFontSize(){
		...
		final com.bun.popupnotifications.SeekBarPreference customPref = (com.bun.popupnotifications.SeekBarPreference) findPreference("app_font_size1");
